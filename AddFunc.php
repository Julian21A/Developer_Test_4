...
try {
    $apiResponse = $client->cms()->hubdb()->rowsApi()->createTableRow("developer_test_4", $HubDbTableRowV3Request);
    echo json_encode($apiResponse);
} catch (Exception $e) {
    echo json_encode("Exception when calling rows_api->create_table_row: ", $e->getMessage());
}
